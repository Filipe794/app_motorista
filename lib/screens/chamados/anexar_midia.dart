...
class AnexarMidia extends StatefulWidget {
  final String userName; // <-- adiciona o parâmetro

  const AnexarMidia({super.key, required this.userName});

  @override
  State<AnexarMidia> createState() => _AnexarMidiaState();
}

class _AnexarMidiaState extends State<AnexarMidia> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                              ...
                              : Center(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Toque para anexar fotos ou vídeos',
                                        style: TextStyle(
                                          color: Colors.grey[600],
                                          fontSize: 16,
                                        ),
              ...
              const Text(
                'Você pode anexar fotos ou vídeos que ajudem a descrever o problema.',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey,
                ),
          ...
          child: ElevatedButton(
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      LoadingScreen(userName: widget.userName),
                ),
              );
            },
            style: ElevatedButton.styleFrom(
